...
> (archivo `.md`) y una versión R (archivo `.R`). Para reproducir
> análisis Utiliza la versión *Raw*" del archivo`.R`, porque desde ésta
> podrás copiar código y pegarlo en R sin problemas. La otra versión, la
> `.md`, te sirve para ver el resultado “tejido” que obtendrías al
